...
class Game:
    ...
    def __init__(self):
        ...
        self.display.pack(side='top', fill='both', padx=4, pady=4)
    ...
    def player_play(self):
        ...
        self.root.after(100_000_000, self.computer_play)
    ...
    def computer_play(self):
        ...
        if self.board.is_checkmate():
            ...
            self.display.label_status["text"] = "Computer's turn. The computer is thinking..."
